            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                   ...
                   // html += '					<div class="webuploader_pick">选择文件</div>';
                    ...
                    html += '							<img class="upload_image" src="/public/static/upImage/zyupload/skins/images/add_img.png" style="width:expression(this.width > ' + imgWidth + " ? " + imgWidth + 'px : this.width)" />';
                    html += "						</div>";
                    html += "					</a>";
                    html += "				</div>";
                    html += "			</div>";

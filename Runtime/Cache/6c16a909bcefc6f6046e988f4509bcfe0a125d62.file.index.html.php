<?php /* Smarty version Smarty-3.1.6, created on 2017-11-24 10:36:00
         compiled from "D:/phpStudy/WWW/mingyou/Home/View\Query\index.html" */ ?>
<?php /*%%SmartyHeaderCode:270105a1785907f6e33-71201455%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '270105a1785907f6e33-71201455',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5a17859084cd4',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5a17859084cd4')) {function content_5a17859084cd4($_smarty_tpl) {?><span id="head"></span>
                    ...
                    if (returnJSON.status) {
                        ...
                        layer.open({
                            ...
                            success: function (layero, index) {
                                ...
                                $('#discript img').css('max-width','550px');
                            }
                        });
                    } else {
